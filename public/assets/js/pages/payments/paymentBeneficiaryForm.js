...
async function prepareBeneficiaryForm(currentType, mode) {
    ...
    $.each(paySubTypes, (i) => {
        ...
        const option = `<option value='${paymentCode}' data >${paymentDescription} </option>`;
        $("#select_payment_sub_type").append(option);
    });

    // if (currentType === "MOM") {
    //     $("#beneficiary_form_header").addClass("bg-same-bank");
    //     $("#beneficiary_form_title").text(`${mode} Mobile Money Beneficiary`);
    ...
    //     $("#beneficiary_form_title").text(`${mode} Airtime Beneficiary`);
    //     $(".other-bank-form").show();
    //     $("#account_number").attr("disabled", true);
    //     await getLocalBanks();
    // } else if (currentType === "UTL") {
    //     $("#beneficiary_form_header").addClass("bg-international-bank");
    //     $("#beneficiary_form_title").text(`${mode} Utility Beneficiary`);
    //     await getCountries();
