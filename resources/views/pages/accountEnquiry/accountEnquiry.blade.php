                                    ...
                                    <div class="row m-1">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <input class="col-md-5" type="text" placeholder="Amount 0.00"
                                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')">
                                                        <div class="col-md-1"></div>
                                                        <select class="form-control col-md-6" id="amount_range" required>
                                                            <option value=""> -- Range --</option>
                                                            <option value="001~>"> > (Greater) </option>
                                                            <option value="002~<"> < (Less)</option>
                                            ...
                                            <table class="table mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b>11,451,523.00</b></td>
                                                        <td> <b>Others</b> </td>
                                                        <td> <b>Transfer to mum for hospital bills</b> </td>
                                                    </tr>
                                                    <tr>
                                                        <td><b> 03/05/2021 &emsp; 10:30:29</b> </td>
                                                        <td class="text-danger"><b>1,000.00</b> </td>
                                                        <td><b>11,450,523.00</b></td>
                                                        <td> <b>Others</b> </td>
                                                        <td> <b>Transfer to mum for hospital bills</b> </td>
                                                    </tr>
                            ...
                            {{--  <div class="row ">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class=" d-none d-md-inline-block">
                                        ...
                                        <div class="btn-group mb-2">
                                            <input type="text" id="startDate" class="form-control date-picker-startDate flatpickr-input input-sm" readonly="readonly">
                                            <input type="text" id="endDate" class="form-control date-picker-endDate flatpickr-input input-sm" readonly="readonly">
