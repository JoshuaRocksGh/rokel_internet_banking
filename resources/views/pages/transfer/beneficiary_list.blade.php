...
<div>
    ...
    $basePath = "Transfer";
    $currentPath = "Transfer Beneficiary List";
    @endphp
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                <div class="row" id="transaction_form">
                                                    <ul class="nav nav-fill nav-pills mb-3" id="details_tab"
                                                        role="tablist">
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link active" id="bank_details_tab"
                                                                data-toggle="pill" href="#bank_details" role="tab"
                                                                aria-controls="bank_details" aria-selected="true">Bank
                                                                Details</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link" id="account_details_tab"
                                                                data-toggle="pill" href="#account_details" role="tab"
                                                                aria-controls="account_details"
                                                                aria-selected="false">Account Details</a>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <a class="nav-link" id="personal_details_tab"
                                                                data-toggle="pill" href="#personal_details" role="tab"
                                                                aria-controls="personal_details"
                                                                aria-selected="false">Personal Details</a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content w-100" id="pills-tabContent">
                                                        <div class="tab-pane fade w-100 show active" id="bank_details"
                                                            role="tabpanel" aria-labelledby="bank_details_tab">
                                                            <div class="form-group row">
                                                                <label class="col-4"> Select Bank:<span
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-4">Bank Swift Code:<span
                                                                        class="text-danger">*</span></label>
                                                                <div class="col-8">
                                                                    <input type="text" class="form-control"
                                                                        id="swift_code" placeholder="Bank Swift Code"
                                                                        required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane fade w-100 show active"
                                                            id="account_details" role="tabpanel"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-8">
                                                                    ...
                                                                    <select class="custom-select" id="select_currency"
                                                                        required>
