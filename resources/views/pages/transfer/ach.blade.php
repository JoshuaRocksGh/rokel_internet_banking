...
<<<<<<< HEAD
                                    ...
                                    <div class="select_onetime">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4">Nickname <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="custom-select col-md-8" id="onetime_beneficiary_account_currency"
                                                required>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4">Enter Telephone Number <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control col-md-8" id="onetime_beneficiary_phone"
                                    ...
                                    <div class="form-group row">
                                        <label class=" col-md-4">Enter Amount <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control  col-md-8" id="amount"
                                            placeholder="Amount: 0.00"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')"
                                            required>
