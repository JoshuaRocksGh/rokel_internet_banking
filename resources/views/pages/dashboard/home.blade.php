...
<div class="card-box "
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a href="#home" data-toggle="tab" aria-expanded="false" class="nav-link active" id="casa_chart_tab">
                <strong class="text-success">CURRENT & SAVINGS</strong>
            </a>
        </li>
        <li class="nav-item">
            <a href="#profile" data-toggle="tab" aria-expanded="true" class="nav-link " id="investment_chart_tab">
                <strong class="text-warning">INVESTMENTS</strong>
            </a>
        </li>
        <li class="nav-item">
            <a href="#messages" data-toggle="tab" aria-expanded="false" class="nav-link" id="loans_chart_tab">
                <strong class="text-danger">LOANS</strong> &nbsp;
            </a>
        </li>
    </ul>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="form-group">
                        ...
                        <div>
                            <input type="number" class="form-control" required placeholder="Enter only numbers"
                                id="exchange_amount" />
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="bs-example-modal-lg" role="dialog"
    style="position: absolute; left:50%; top:60%;transform: translate(-50%, -50%);" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive table-bordered my_investment_display_area" style="display: none">
