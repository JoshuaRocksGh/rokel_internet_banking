                                ...
                                <table id="" class="table mb-0 ">
                                    ...
                                    <tbody class="transaction_history">
                                        ...
                                        <tr class="text-center text-center">
                                            <td colspan="5"><img src="{{ asset('assets/images/no_data.png') }}" alt=""
                                                    width="150">
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    if (response.responseCode == '000') {
                        ...
                        if (response.data.length > 0) {
                            ...
                            $.each(data, function(index) {
                                ...
                                var rollover_ = data[index].rollover;
                        ...
                        $.each(data, function(index) {
                            ...
                            $(".transaction_history").append(
                                `
                                            ...
                                            <tr>
                                                <td>  <b>${data[index].postingSysDate}</b></td>
                                                <td> <b> ${data[index].batchNumber} </b>  </td>
                                                <td> <b> ${data[index].narration}  </b>  </td>
                                                <td> <b> ${global_selected_currency} ${formatToCurrency(parseFloat(data[index].amount))}</b> </b></td>
                                                <td> <b> ${data[index].runningBalance}  </b>  </td>
                                            </tr>
                                                                `
                            )
                        })
