                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <p class="col-6"><span class="font-weight-light">Firstname:</span></p>
                                                <span class="font-weight-semibold col-6" id="display_firstname"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light"> Gender:</span></p>
                                                <span class="font-weight-semibold col-6"
                                                    id="display_select_gender"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light"> Date of Birth:</span>
                                                </p> <span class="font-weight-semibold col-6" id="display_DOB"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light"> Place of Birth:</span>
                                                </p><span class="font-weight-semibold col-6"
                                                    id="display_birth_place"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light"> Country: </span></p>
                                    ...
                                    <div id="row">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <p class="col-6"><span class="font-weight-light">Mobile Number:</span>
                                                </p> <span class="font-weight-semibold col-6"
                                            ...
                                            <div class="row">
                                                ...
                                                <p class="col-6"><span class="font-weight-light">City:</span></p> <span
                                                    class="font-weight-semibold col-6" id="display_city"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light">Town:</span></p> <span
                                                    class="font-weight-semibold col-6" id="display_town"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light"> Residential
                                                        Address:</span></p><span class="font-weight-semibold col-6"
                                                    id="display_residential_address"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light ">ID Type:<span></p>
                                                </span><span class="font-weight-semibold col-6"
                                                    id="display_id_type"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light ">ID Number:<span></p>
                                                <span class="font-weight-semibold col-6" id="display_id_number"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light ">Date Issued:<span></p>
                                                <span class="font-weight-semibold col-6" id="display_issue_date"></span>
                                            </div>
                                            <div class="row">

                                                <p class="col-6"><span class="font-weight-light ">Date of Expiry:<span>
                                                </p><span class="font-weight-semibold col-6"
                                                    id="display_expiry_date"></span>
                                            </div>
                                        </div>
                                        <p class="mb-1"><span class="font-weight-light "> <b> ID image: </b> <br> <img
                                                    class="img-fluid display_selected_id_image" id="previewImg" src="#"
                                                    alt="your image" /><span class="font-weight-semibold mr-3"
                                                    id="display_title"> &nbsp</span>
                                    </div>
                                    <h5 class="mb-3 mt-4 bg-light p-2"> Bio Details</h5>
                                    <div>
                                        <p class="mb-1"><span class="font-weight-light mr-2"><b> Passport Picture: </b>
                                                <br> <img class="img-fluid display_passport_picture previewImg1"
                                                    ...
                                                    &nbsp</span></span></p>
                                        <p class="mb-1"><span class="font-weight-light mr-2"> <b> Selfie Image: </b>
