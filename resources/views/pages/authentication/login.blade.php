                    ...
                    <div class="card d-flex h-100" style="background-color: rgba(245, 245, 245, 0);zoom: 0.8 ;">
                                            ...
                                            <a href="{{ url('account-creation') }}">
                                                <div class="text-center card-box">
                                                    <div class="pt-1 pb-1">
                                                        ...
                                                        <h4 class="mt-3 font-28"><a href="{{ url('account-creation') }}"
                        ...
                        <div class="col-md-3">
                            <a href="{{ url('enquiry') }}">
                                <div class="text-center card-box">
                                    <div class="pt-1 pb-1">
                                        <i class=" fas fa-desktop text-blue font-22" style="font-size: 100px;"></i>
                        ...
                        <div class="col-md-12">
                            <div class="text-center card-box">
                                <div class="pt-1 pb-1">
                                    ...
                                    <i class="fas fa-headset text-blue font-22" style="font-size: 100px;"></i>

                                    <h4 class="mt-3 font-28"><a href="{{ url('faq') }}" class="text-blue">FAQ</a>
                                    </h4>
