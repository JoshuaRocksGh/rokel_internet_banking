            ...
            <div class="col-md-4 text-right">
                <h6>
                    ...
                    <span class="flaot-right">
                        <b class="text-primary"> Transfer </b> &nbsp; > &nbsp; <b class="text-danger">Tansfer Status</b>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 m-2 customize_card" id="transaction_summary"
                            ...
                            <div class="p-3 mt-4 mt-lg-0 rounded table-responsive">
                                ...
                                <table id="datatable-buttons"
                                    class="table dt-responsive nowrap w-100 pending_transaction_request " style="zoom: 1;">
                                    <thead>
...
@section('scripts')
    ...
    <script>
        function get_corporate_requests(customerNumber) {
            ...
            $.ajax({
                type: "GET",
                url: "get-transfer-status?customerNumber=" + customerNumber,
                ...
                error: function(xhr, status, error) {
                    ...
                    setTimeout(function() {
                        get_corporate_requests(customerNumber)
