...
<head>
        ...
        <!-- Bootstrap core CSS -->
        <link rel="stylesheet" href="{{ asset('land_asset/css/bootstrap.min.css') }}" type="text/css">

        <!--Material Icon -->
        <link rel="stylesheet" type="text/css" href="{{ asset('land_asset/css/materialdesignicons.min.css') }}" />

        <!-- Custom  sCss -->
        <link rel="stylesheet" type="text/css" href="{{ asset('land_asset/css/style.css') }}" />
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                   ...
                   <a href="{{ url('login') }}">
                        <button class="btn btn-info navbar-btn">Login to Internet Banking</button>
                   </a>
                </div>
            </div>
        </nav>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 offset-xl-2 col-lg-5 offset-lg-1 col-md-7">
                                <div class="home-img position-relative">
                                    <img src="{{ asset('land_asset/images/home-img.png') }}" alt="" class="home-first-img">
                                    <img src="{{ asset('land_asset/images/home-img.png') }}" alt="" class="home-second-img mx-auto d-block">
                                    <img src="{{ asset('land_asset/images/home-img.png') }}" alt="" class="home-third-img">
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="client-images">
                                <img src="{{ asset('land_asset/images/clients/1.png') }}" alt="logo-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="client-images">
                                <img src="{{ asset('land_asset/images/clients/3.png') }}" alt="logo-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="client-images">
                                <img src="{{ asset('land_asset/images/clients/4.png') }}" alt="logo-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="client-images">
                                <img src="{{ asset('land_asset/images/clients/6.png') }}" alt="logo-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                    </div> <!-- end row -->
                </div>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center mb-4 pb-1">
                            ...
                            <p class="text-muted">The clean and well commented code allows easy customization of the theme.Its designed for describing your app, agency or business.</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{ asset('land_asset/images/icons/layers.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{ asset('land_asset/images/icons/core.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{ asset('land_asset/images/icons/paperdesk.png') }}" alt="">
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{ asset('land_asset/images/icons/solarsystem.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{ asset('land_asset/images/icons/datatext.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{ asset('land_asset/images/icons/browserscript.png') }}" alt="">
                            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{ asset('land_asset/images/demo/index_1.jpg') }}" alt="" class="img-fluid mx-auto d-block">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{ asset('land_asset/images/demo/index_2.jpg') }}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{ asset('land_asset/images/demo/index_3.jpg') }}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{ asset('land_asset/images/demo/index_4.jpg') }}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{ asset('land_asset/images/demo/index_5.jpg') }}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{ asset('land_asset/images/demo/index_6.jpg') }}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
        ...
        <section class="section">
            <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="feature-img">
                            <img src="{{ asset('land_asset/images/features-img/img-2.png') }}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row align-items-center mt-5">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-img">
                            <img src="{{ asset('land_asset/images/features-img/img-1.png') }}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                </div>
                <!-- end row -->
        ...
        <section class="section pb-0 bg-gradient" id="pricing">
            <div class="bg-shape">
                <img src="{{ asset('land_asset/images/bg-shape.png') }}" alt="" class="img-fluid mx-auto d-block">
            </div>
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-white-50">The clean and well commented code allows easy customization of the theme.Its designed for describing your app, agency or business.</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row">
                        ...
                        <div class="testi-box mt-4">
                            ...
                            <div class="p-4">
                                <div class="testi-img float-left mr-2">
                                    <img src="{{ asset('land_asset/images/testi/img-2.png') }}" alt="" class="rounded-circle">
                                </div>
                                <div>
                    ...
                    <div class="col-lg-4">
                        <div class="testi-box mt-4">
                            ...
                            <div class="p-4">
                                <div class="testi-img float-left mr-2">
                                    <img src="{{ asset('land_asset/images/testi/img-1.png') }}" alt="" class="rounded-circle">
                                </div>
                                <div>
                    ...
                    <div class="col-lg-4">
                        <div class="testi-box mt-4">
                            ...
                            <div class="p-4">
                                <div class="testi-img float-left mr-2">
                                    <img src="{{ asset('land_asset/images/testi/img-3.png') }}" alt="" class="rounded-circle">
                                </div>
                                <div>
        ...
        <section class="section pb-0 bg-gradient" id="contact">
            <div class="bg-shape">
                <img src="{{ asset('land_asset/images/bg-shape-light.png') }}" alt="" class="img-fluid mx-auto d-block">
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="container-fluid">
                <div class="row mb-5">
                    <div class="col-lg-4">
                        <div class="pr-lg-4">
                            <div class="mb-4">
                                <img src="{{ asset('land_asset/images/logo-light.png') }}" alt="" height="20">
                            </div>
        ...
        <script src="{{asset('land_asset/js/bootstrap.bundle.min.js') }}"></script>
        <script src="{{asset('land_asset/js/jquery.easing.min.js') }}"></script>
        <script src="{{asset('land_asset/js/scrollspy.min.js') }}"></script>

        <!-- custom js -->
        <script src="{{asset('land_asset/js/app.js') }}"></script>
    </body>


<!-- Mirrored from coderthemes.com/ubold/landing/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Mar 2021 18:52:53 GMT -->
</html>
