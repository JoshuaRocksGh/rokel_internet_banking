                            ...
                            <form action="#">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select ">
                                        ...
                                        <option value="1"><img src="{{ asset('assets/images/mtn.png') }}" alt="image" class="img-fluid avatar-xs rounded"> MTN</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" data-toggle="input-mask" data-mask-format="00/00/0000" placeholder="Enter Mobile Number">
                                    {{--  <span class="font-13 text-muted">e.g "DD/MM/YYYY"</span>  --}}
                                </div>
                                {{--  <div class="form-group">
                                    <label>Account Name</label>
