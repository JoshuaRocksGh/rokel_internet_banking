                                ...
                                <div class="col-md-7">
                                    <form action="#" id="payment_details_form" autocomplete="off" aria-autocomplete="none">
                                        ...
                                        <div class="form-group">
                                            <label class="h6">Requst Payment to</label>
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control" placeholder="Beneficiary's BBAN(USG Client)"/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control" placeholder="Beneficiarys phone number(Eg. 233547888890)"/>
                                        </div>
