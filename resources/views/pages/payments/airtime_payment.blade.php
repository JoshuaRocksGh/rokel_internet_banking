                                ...
                                <div class="col-md-7">
                                    <form action="#" id="payment_details_form" autocomplete="off" aria-autocomplete="none">
                                        ...
                                        <div class="form-group select_beneficiary" >
                                            <label class="h6">Beneficiary Number</label>

                                            <select class="custom-select" id="to_account" required>
                                                <option value="">Select Beneficiary</option>
                                                <option value="MTN ~Joshua Amarfio~0549899999~GHS~80">
                                                    MTN ~ 0549888888 </option>
                                            </select>
...
<hr>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" id="onetime_beneficiary_account_currency" required>
                                                    ...
                                                    <option style="background-image:url({{ asset('assests/images/mtn.png') }});" value="Vodafone">Vodafone</option>
                                            ...
                                            <div class="form-group">
                                                {{--  <label class="">Enter Account Number</label>  --}}
                                                <input type="text" class="form-control" id="onetime_beneficiary_email"
