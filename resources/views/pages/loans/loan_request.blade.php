                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <b class="col-md-6 text-primary align-self-center">Loan Product
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <b class="col-md-6 text-primary align-self-center"
                                                            for="loan_amount">
                                                            Amount
                                                            <span class="text-danger">*</span></b>
                                                    ...
                                                    <div class="form-group row mb-3" id="pay_from_account">
                                                        ...
                                                        <b class="col-md-6 text-primary align-self-center">Interest Rate
                                                            Type &nbsp;
                                                            <span class="text-danger">*</span></b>

                                                        <select class="form-control col-md-6" id="interest_rate_type"
                                                            required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <b class="col-md-6 text-primary align-self-center"> Principal
                                                            Repay Frequency
                                                            &nbsp; <span class="text-danger">*</span></b>


                                                        <select class="form-control col-md-6 loan_frequencies"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <b class="col-md-6 text-primary align-self-center"> Interest
                                                            Repay Frequency
                                                            &nbsp; <span class="text-danger">*</span></b>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <b class="col-md-6 align-self-center text-primary"
                                                            for="loan_duration">
                                                            Loan duration
                                                            <span class="text-danger">*</span></b>
                                                        <input type="text" class="form-control col-md-6"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <b class="col-md-6 align-self-center text-primary"
                                                            ...
                                                            <span class="text-danger">*</span></b>
                                                        <select class="form-control col-md-6 loan_frequencies"
                                                            id="loan_purpose" placeholder="Select Pick Up Branch"
                                                            required>
                                                            <option value="">Select Interest Repay Frequency</option>
                                                        </select>
                                                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#btn_submit_loan_request').click(function () {
                ...
                if (loan_product == "" || loan_amount == "" || loan_duration == "" ||
                    interest_rate_type == "" || principal_repay_freq == "" || interest_repay_freq ==
                    "" || loan_purpose == "") {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.responseCode == '000') {
                                toaster("Loan request successful. Approval pending with application number as " +
                                    response.message, 'success', 20000)
                                ...
                                toaster('kindly check your input and resubmit your loan request',
                                    'error', 90000);
                                $('#spinner').hide()
                                $('#spinner-text').hide()
                                $(".submit-text").show()
