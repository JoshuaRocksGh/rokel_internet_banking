                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <select class="form-control col-md-8 " id="my_account" required>
                                                        ...
                                                        <div class="form-group row mb-3" id="pay_from_account">
                                                            ...
                                                            <b class="col-md-4 text-primary">Type Of Statement &nbsp;
                                                                <span class="text-danger">*</span></b>

                                                            <select class="form-control col-md-8" id="statementType"
                                                                required>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <input type="date" id="endDate" class="form-control col-md-8" />
                                                            <br>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#btn_submit_request_statement').click(function() {
                    ...
                    if (my_account == "" || type_of_statement == "" || transStartDate == "" || transEndDate ==
                        "" || pin == "") {
                        toaster("Please fill all required fields", "error", 6000);
                    } else {
