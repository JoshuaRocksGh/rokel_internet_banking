...
<section class="col-md-7 px-3">
    <div class="site-card h-100" id="transaction_form"> <br>
        <div class="container">
                            ...
                            <div class="tab-pane fade" id="onetime_view" role="tabpanel" aria-labelledby="onetime_tab">
                                <div class="col-12">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <select class="form-control col-md-8" id="onetime_beneficiary_bank_name"
                                            required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group mb-1 col-md-8" style="padding: 0px;">
                                    <div class="input-group-prepend">
                                        <input type="text" class="input-group-text account_currency "
